...
def load_eval_data_reference(test_file, test_id_file, name, cold, train_data, citeu=False):
...
class EvalDataReference:
    ...
    def init_tf(self, user_factors, item_factors, user_content, item_content, eval_run_batchsize):
        self.refe_test_user_ids = self.test_user_ids - 10000
        # self.U_pref_test = user_factors[self.test_user_ids, :]
        self.U_pref_test = user_factors[self.refe_test_user_ids, :]
        ...
        if user_content is not None:
            ...
            self.U_content_test = user_content[self.refe_test_user_ids, :]
